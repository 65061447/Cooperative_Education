    ...
    const fetchEmployees = async () => {
      try {
        ...
        if (!res.ok) {
          ...
          // 🚫 Invalid token → clear but stay on page
    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-grow p-8 container mx-auto space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-black text-[#334e5e] tracking-tight">
            อัตราคนในแต่ละเจเนอเรชั่นของลูกจ้างประเภทต่างๆ
          </h1>
        ...
        <div className="flex bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8 h-[650px] gap-8">
          <div className="flex-[4] relative">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={displayedData}
                margin={{ top: 20, right: 10, left: -20, bottom: 100 }}
              >
                ...
                {gens.map((gen) => (
                  <Bar
                    ...
                    stackId="a"
                    fill={gen.color}
                    hide={hiddenGens.includes(gen.key)}
                    barSize={50}
                  >
                    {displayedData.map((entry, i) => (
                      <Cell
                        ...
                        fillOpacity={
                          ...
                          !selectedTypes.includes(entry.name)
                            ? 0.2
                            : 1
                        }
                      />
          ...
          <div className="flex-1 border-l border-slate-100 pl-8 flex flex-col h-full overflow-hidden">
            ...
            <div className="flex-grow overflow-y-auto space-y-2 pr-2">
              <span className="text-[9px] font-bold text-slate-300 uppercase block mb-1">
                Personnel Type
              </span>
